package com.dragon.memory.user.controller;
...
import com.dragon.memory.utils.PasswordUtils;
import com.dragon.memory.utils.StringUtil;
...
public class UserController {
    ...
    public String login(HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        if(auto!=null){
            String userinfo=username+"#"+PasswordUtils.getPasswordMD5(password, passwordSalt, 1024);
    ...
    public String modifyPassword(HttpServletRequest request){
        ...
        password=PasswordUtils.getPasswordMD5(password, user.getPasswordSalt(), 1024);
