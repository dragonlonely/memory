	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<div id="left_tab" style="margin-top: 70px;" class="collapse navbar-default navbar-collapse">
			<ul class="nav panel-group" id="myPanel">
				...
				<li class="panel">
					<a href="#sub3" data-toggle="collapse" data-parent="#myPanel"> 图片管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub3" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showPicturesType">
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看图片分类
							</a>
						</li>
						<li>
							<a href="#" id="addPicturesType">
								<span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;添加图片分类
							</a>
						</li>
						<li>
							<a href="#" id="showPictures" >
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看图片
							</a>
						</li>
						<li>
							<a href="#" id="addPictures">
		...
		<div class="page_main">
			<script type="text/javascript">
                $("#logout").click(function(){
                    $(".dv_content").attr("src","${pageContext.request.contextPath}/admin/logout.action");
                })
				$("#showUser").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getuserlist.action");
				})
                $("#invalid").click(function(){
                    $(".dv_content").attr("src","${pageContext.request.contextPath}/admin/getinvaliduserlist.action");
                })
				$("#showPicturesType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/goods/getpicturestype.action");
				})
				$("#addPicturesType").click(function(){
